> [!WARNING]
> ### ⚠️ Security Notice from the Maintainer
>
> * **Mechanism:** This calculator utilizes PHP's `eval()` function for parsing mathematical expressions.
> * **Risk:** Although input sanitization is implemented, `eval()` poses inherent security risks (RCE) and is generally considered unsafe for production environments.
> * **Usage:** This project is intended for **educational purposes** and **local usage**. We strongly advise **AGAINST** deploying this code on a public web server without implementing a proper parser (like Shunting-yard algorithm).
...
## Creator : [@Hodemcsuk](https://github.com/Hodemcsuk)
